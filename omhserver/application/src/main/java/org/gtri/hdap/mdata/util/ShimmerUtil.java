...
public class ShimmerUtil {
    ...
    public static String OBSERVATION_PHYSICAL_ACTIVITY_CATEGORY_CODE = "physical-activity";
    public static String OBSERVATION_HEART_RATE_CATEGORY_CODE = "vital-signs";
    public static String OBSERVATION_PHYSICAL_ACTIVITY_CATEGORY_DISPLAY = "Physical Activity";
    public static String OBSERVATION_HEART_RATE_CATEGORY_DISPLAY = "Vital Signs";
