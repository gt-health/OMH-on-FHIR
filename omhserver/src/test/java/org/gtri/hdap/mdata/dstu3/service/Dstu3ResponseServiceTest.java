...
public class Dstu3ResponseServiceTest {

    @TestConfiguration
    static class ResponseServiceTestContextConfiguration{
        @Bean
        public Dstu3ResponseService responseService(){
            return new Dstu3ResponseService();
        }
    }
    ...
    private Logger logger = LoggerFactory.getLogger(Dstu3ResponseServiceTest.class);
    ...
    public void testParseDate() throws Exception{
        ...
        Date date = dstu3ResponseService.parseDate(expected);
        assertTrue(date != null);
        date = dstu3ResponseService.parseDate(nomillis);
        assertTrue(date != null);
        boolean hadError = false;
        try {
            date = dstu3ResponseService.parseDate(notExpected);
        }
    ...
    public void testGenerateDocumentReference() throws Exception{
        ...
        DocumentReference documentReference = dstu3ResponseService.generateDocumentReference("doc123", "fitbit");
