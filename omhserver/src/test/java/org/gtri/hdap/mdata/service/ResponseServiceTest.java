...
public class ResponseServiceTest {
    ...
    public void testGenerateObservation() throws Exception{
        ...
        //    ]
        //}
        String sb = FileUtils.readFileToString(new File("src/main/resources/omhtestresponse1.json"), UTF_8);
        List<Resource> observationList = responseService.generateObservationList("123456", sb);
